  ...
  $.getJSON('./mapped_source.json', function (data) {
    ...
    function generateUtilSection(util, key) {
      _(util).forEach(function (val) {
        ...
        '<a target="source" href="https://github.com/iamdevlinph/common-utils-pkg/blob/master/src/' + val.method + '/' + val.method + '.js#L' + val.lineStart + '-L' + val.lineEnd + '" class="dashed util__source">source</a>' +
